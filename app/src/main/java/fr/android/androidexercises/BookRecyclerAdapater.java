...
/**
 * Created by Manon on 18/12/2017.
 */

class BookRecyclerAdapater extends RecyclerView.Adapter<MyViewHolder> {

    private final List<Book> books;
    private final LayoutInflater inflater;

    public BookRecyclerAdapater(Context context, List<Book> books) {
        this.books = books;
